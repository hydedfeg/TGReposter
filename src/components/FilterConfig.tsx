...
export default function FilterConfig({ filters, onUpdateFilters, readOnly = false }: FilterConfigProps) {
    ...
    <div className="bg-white rounded-xl border border-slate-200 shadow-xs p-5">
      <div className="flex justify-between items-center border-b border-slate-100 pb-4 mb-6">
        ...
        <button
          ...
          disabled={readOnly}
          className="inline-flex items-center gap-2 text-xs font-semibold text-slate-600 bg-slate-50 hover:bg-slate-100 border border-slate-100 px-3 py-1.5 rounded-lg transition-colors cursor-pointer disabled:opacity-75 disabled:cursor-not-allowed"
        >
